...
We are using the dataset ParlScot. This data is publicly available for free. It consists of scraped data from Scottish plenary debates. The data is relational and is stored as semi-structured data.
